...
const pujas = [
  ...
  },
  {
    ...
    "muhurat": "2026-08-09T08:00:00+05:30",
    "price": 816,
    "cat": "All",
    "image": "assets/images/pujas/narasimha.jpg",
    "detail": {
      "mantra": "OM NARASIMHAYA NAMAHA",
  ...
  },
  {
    ...
    "detail": {
      "mantra": "OM NAMO VENKATESAYA",
      "about": "వేద మంత్రాల నిరంతర పఠన మధ్య, పాలు, తేనె, గంధం, పవిత్ర జలాలు వంటి 108 పవిత్ర ద్రవ్యాలతో శ్రీ వేంకటేశ్వర స్వామికి ఈ వైభవయుతమైన అభిషేకం నిర్వహించబడుతుంది. మీ గోత్రనామాలతో కూడిన మీ సంకల్పం, అత్యంత పవిత్రమైన ఈ 'కామిక ఏకాదశి' విశేష పూజా కార్యక్రమంలో మీ ప్రార్థనలను నేరుగా చేరవేస్తుంది.",
      "tradition": "వైష్ణవ వైదిక సంప్రదాయం",
      "duration": "సుమారు 2.5 గంటలు",
      "forWhom": "వ్యక్తి లేదా కుటుంబం"
    },
    "id": "Venkateswara Swamy Abhishekam-te",
    "basePrice": 999,
    "language": "te"
  },
  {
