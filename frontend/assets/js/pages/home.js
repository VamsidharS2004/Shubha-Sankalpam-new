    ...
    <div class="hero-slide hero-slide-overlay ${i === currentSlide ? 'active' : ''}" data-slide="${i}">
      <div class="hero-image-wrap">
        ...
        <div class="hero-copy">
          ...
          <div class="hero-meta">
            <span class="hm-item"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg> ${p.temple}</span>
            <span class="hm-item"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg> ${p.date}</span>
          </div>
        </div>
...
/* ============================================================
   GALLERY LIGHTBOX â€” click any tile to preview it fullscreen,
...
(function initGalleryLightbox() {
  ...
  function openAt(i) {
    ...
    if (img) {
      ...
      frame.innerHTML = `<div class="demo-media"><span class="demo-media-icon">ðŸª”</span><span class="demo-media-label">${tile.dataset.caption || ""}</span></div>`;
    }
